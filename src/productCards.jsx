	...
	return (
		<div className='products'>
			{products.map((product, i) => (
				...
				>
					<div className='product-availability-months'>
						{narrowMonthStrings.map((month, j) => (
							<TooltifiedBadge
					...
					<div className='product-some-numbers'>
						<div className='product-some-numbers--local'>
							...
							<Button
								className='local-interrogation-handler'
								onClick={() => setLocalInterrogation(true)}
							>
								?
							</Button>
						</div>
						<div className='product-some-numbers--co2'>
							<span className='product-some-numbers--highlighting'>
								{product.CO2 ?? "?"}
							</span>{" "}
							kgCO2e/kg
							<Button
								className='co2-interrogation-handler'
								onClick={() => setCO2Interrogation(true)}
							>
								?
							</Button>
						</div>
			...
			<AnchorDialog
				title='Pourquoi consommer local ?'
